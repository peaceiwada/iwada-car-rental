...
import { FaStar, FaGasPump, FaUsers, FaCog, FaCalendarAlt, FaArrowLeft, FaCheckCircle, FaMapMarkerAlt, FaCar, FaTimesCircle, FaExpand } from 'react-icons/fa'
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-md p-6 sticky top-24">
              ...
              <div className="flex gap-3">
                <ShareButton car={car} />
                <Link href={`/booking/${car.id}`} className="flex-1">
                  <button className="w-full bg-amber-600 text-white py-2.5 rounded-xl font-semibold text-sm hover:bg-amber-700 transition-all duration-300">
                    Proceed to Book
                  </button>
                </Link>
              </div>
